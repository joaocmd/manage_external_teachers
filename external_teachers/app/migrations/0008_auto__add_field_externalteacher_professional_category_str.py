...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExternalTeacher.professional_category_str'
        db.add_column(u'app_externalteacher', 'professional_category_str',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ExternalTeacher.professional_category_str'
        db.delete_column(u'app_externalteacher', 'professional_category_str')
