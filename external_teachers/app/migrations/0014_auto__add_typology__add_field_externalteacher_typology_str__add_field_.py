...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'app_externalteacher', ['semester_id', 'ist_id'])
    ...
    def backwards(self, orm):
        # Deleting model 'Typology'
        db.delete_table(u'app_typology')

        # Deleting field 'ExternalTeacher.typology_str'
        db.delete_column(u'app_externalteacher', 'typology_str')

        # Deleting field 'ExternalTeacher.typology'
        db.delete_column(u'app_externalteacher', 'typology_id')

        # Adding unique constraint on 'ExternalTeacher', fields ['semester', 'ist_id']
        db.create_unique(u'app_externalteacher', ['semester_id', 'ist_id'])
