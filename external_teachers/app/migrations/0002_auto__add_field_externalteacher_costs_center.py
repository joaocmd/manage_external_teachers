...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExternalTeacher.costs_center'
        db.add_column(u'app_externalteacher', 'costs_center',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExternalTeacher.costs_center'
        db.delete_column(u'app_externalteacher', 'costs_center')
