...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Migrate all professional categories from professional_category
        # to professional_category_str
        teachers = orm.ExternalTeacher.objects.all()
        for teacher in teachers:
            teacher.professional_category_str = teacher.professional_category
            teacher.save()
