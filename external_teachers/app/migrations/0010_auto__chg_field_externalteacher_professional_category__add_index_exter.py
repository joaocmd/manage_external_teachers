...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'ExternalTeacher.professional_category' to match new field type.
        db.rename_column(u'app_externalteacher', 'professional_category', 'professional_category_id')
        ...
        # Adding index on 'ExternalTeacher', fields ['professional_category']
        db.create_index(u'app_externalteacher', ['professional_category_id'])


    def backwards(self, orm):
        # Removing index on 'ExternalTeacher', fields ['professional_category']
        db.delete_index(u'app_externalteacher', ['professional_category_id'])


        # Renaming column for 'ExternalTeacher.professional_category' to match new field type.
        db.rename_column(u'app_externalteacher', 'professional_category_id', 'professional_category')
        # Changing field 'ExternalTeacher.professional_category'
        db.alter_column(u'app_externalteacher', 'professional_category', self.gf('django.db.models.fields.CharField')(default=None, max_length=1))
    ...
    models = {
        u'app.externalteacher': {
            ...
            'professional_category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.ProfissionalCategory']", 'null': 'True'}),
        ...
        u'app.profissionalcategory': {
            'Meta': {'object_name': 'ProfissionalCategory'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
