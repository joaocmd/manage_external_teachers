...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ProfissionalCategory', fields ['slug']
        db.create_unique(u'app_profissionalcategory', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProfissionalCategory', fields ['slug']
        db.delete_unique(u'app_profissionalcategory', ['slug'])
