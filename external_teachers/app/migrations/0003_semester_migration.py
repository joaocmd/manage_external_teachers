...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_semester', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('number', self.gf('django.db.models.fields.IntegerField')()),
            ('year_initial', self.gf('django.db.models.fields.IntegerField')()),
            ('year_final', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'app', ['Semester'])

        # Adding field 'ExternalTeacher.semester'
        db.add_column(u'app_externalteacher', 'semester',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['app.Semester']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Semester'
        db.delete_table(u'app_semester')

        # Deleting field 'ExternalTeacher.semester'
        db.delete_column(u'app_externalteacher', 'semester_id')
    ...
    models = {
        u'app.externalteacher': {
            ...
            'semester': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Semester']"})
        },
